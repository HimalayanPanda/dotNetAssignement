    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuestionAllocations", x => x.ID);
                    table.ForeignKey(
                        name: "FK_QuestionAllocations_Questions_QuestionID",
                        column: x => x.QuestionID,
                        principalTable: "Questions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_QuestionAllocations_Quizzes_QuizID",
                        column: x => x.QuizID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionAllocations_QuestionID",
                table: "QuestionAllocations",
                column: "QuestionID");

            migrationBuilder.CreateIndex(
                name: "IX_QuestionAllocations_QuizID",
                table: "QuestionAllocations",
                column: "QuizID");
